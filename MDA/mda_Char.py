...
def MaxDiss_Simplified_NoThresholdNOR(data, num_centers, ix_scalar): #modified
    ...
    # normalize scalar and directional data
    centroids = subset#, ix_scalar, minis, maxis) #modified
    test = train#, ix_scalar, minis, maxis) #modified


    return centroids, test, minis, maxis
...
def MaxDiss_Simplified_NoThreshold(data, num_centers, ix_scalar): #modified
    ...
    # normalize scalar and directional data
    centroids = DeNormalize(subset, ix_scalar, minis, maxis) #modified
    test = DeNormalize(train, ix_scalar, minis, maxis) #modified
